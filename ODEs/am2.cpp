...
//--- multivariate Adams-Multon O(k^2) method for any explicit first order system of ODEs ---//
...
void ODE::am2(odefun f, arma::vec& t, arma::mat& U, ivp_options& opts) {
...
ODE::ivp_options ODE::am2(odefun f, arma::vec& t, arma::mat& U) {
    ivp_options opts;
