...
int main() {
    ...
    double a = -3; double b = 3; u_long m = 20; u_long n = 300;
    ...
    numerics::ChebInterp pinterp(m, a, b, g);
    ...
    for (int i(0); i < 4; ++i) {
        ...
        else if (i==1) {v = hspline(u); title = "Hermite spline with linear extrapolation";}
        else if (i==2) {v = pinterp(u); title = "Chebyshev";}
