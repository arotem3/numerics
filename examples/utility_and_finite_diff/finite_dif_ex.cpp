...
// g++ -Wall -g -o finite_dif finite_dif_ex.cpp -lnumerics -larmadillo
...
int main() {
    ...
    std::cout << "the derivative of sin(0.5) is: " << df0 << std::endl
              << "\tthe approximation of that derivative with |err| < 1e-5 is: " << df1 << std::endl
    ...
    std::cout << "g(x,y,z) = sqrt(x^2 + y^2 + z^2)" << std::endl
              ...
              << "\tthe approximate gradient of g with |err| < 1e-5 is:" << dg1
