...
/* LINEAR_BVP : solves linear boundary value problem in one variable. */
...
/* SET_BOUNDARIES : set the boundaries of the BVP.
 * --- L <= x <= R. */
...
/* SET_LBC : set left boundary conditions.
 * --- a*u(L) + b*u'(L) == g. */
...
/* SET_RBC : set right boundary conditions.
 * --- a*u(R) + b*u'(R) == g. */
...
/* SPECTRAL_SOLVE : spectral convergence solver.
 * --- x  : vector to store x values.
 * --- U  : vector to store U values.
 * --- m  : number of interior grid points. */
...
/* SOLVE : general solver with choice of method.
 * --- x  : vector to store x values.
 * --- U  : vector to store U values.
 * --- m  : number of interior grid points. 
