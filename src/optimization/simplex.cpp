...
/* simplex(A,x) : simplex method for solving linear constrained maximization problems.
...
/* simplex(f, conRHS, conLHS, x) : simplex method overload for those who would rather not pre-format.
