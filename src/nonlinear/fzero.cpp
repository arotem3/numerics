...
/* NEWTON : finds local root of single variable nonlinear functions using newton's method.
...
/* SECANT : secant methods for finding roots of single variable functions.
...
/* BISECT : bisection method for finding roots of single variable functions
 * --- f  : function to find root of.
 * --- a,b : bracket for root.
...
/* FZERO : adaptively deploys 3 different methods to find root of nonlinear equation
 * --- f  : function to find root of.
 * --- a,b : bracket for root. */
