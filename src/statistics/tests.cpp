...
/* Z_TEST : one sample hypothesis z-test on mean.
 * --- x  : sample statistics.
 * --- mu : theoretical mean.
...
/* Z_TEST : unpaired two sample hypothesis z-test on difference of means.
...
/* T_TEST : one sample hypothesis t-test on mean.
 * --- x  : sample statistics.
 * --- mu : theoretical mean.
 * --- H1 : alternative hypothesis.
 * --- confidence : confidence level. */
...
/* T_TEST : unpaired two sample hypothesis t-test on difference of means.
 * --- x1, x2  : sample statistics for each data set.
 * --- mu : theoretical mean.
 * --- H1 : alternative hypothesis.
 * --- confidence : confidence level. */
...
/* P_TEST : one sample proportions test.
...
/* PERM_TEST : two sample permuations test for difference of means.
 * --- x1 : first data set. 
 * --- x2 : second data set. 
 * --- H1 : alternative hypothesis.
